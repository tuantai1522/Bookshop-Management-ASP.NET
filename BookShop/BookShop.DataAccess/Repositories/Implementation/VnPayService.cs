...
namespace BookShop.DataAccess.Repositories.Implementation
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model)
        {
            ...
            vnpay.AddRequestData("vnp_Amount", (model.Total * 100).ToString()); //Số tiền thanh toán. Số tiền không mang các ký tự phân tách thập phân, phần nghìn, ký tự tiền tệ. Để gửi số tiền thanh toán là 100,000 VND (một trăm nghìn VNĐ) thì merchant cần nhân thêm 100 lần (khử phần thập phân), sau đó gửi sang VNPAY là: 10000000
